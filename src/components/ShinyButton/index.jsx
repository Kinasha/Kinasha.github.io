...
import './index.css'
export function ShinyButton(props) {
  useEffect(() => {
    ...
    const eventId =  document.body.addEventListener('pointermove', UPDATE)
    return () => document.body.removeEventListener(eventId)
  }, [])
  const { text, onClick, classNameName, style } = props
  return (
    <>
